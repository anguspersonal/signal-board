...
export function NetworkClient({ 
  ...
  const networkConnections = serverConnections.length > 0 ? serverConnections : [
    {
      id: 1,
      name: 'Sarah Johnson',
  ...
  const suggestedConnections = serverSuggestions.length > 0 ? serverSuggestions : [
    {
      id: 5,
      name: 'Lisa Wang',
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="mt-2 flex flex-wrap gap-1">
                        {connection.tags.slice(0, 2).map((tag: string) => (
